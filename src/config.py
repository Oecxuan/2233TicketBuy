...
class UserConfig:
    ...
    device_id: str = ""  #
    cookies: dict = field(default_factory=dict)  # 浏览器指纹 cookie（反爬关键） 持久化设备指纹（对齐 BHYG）
    ...
    def save(self, config: Optional[Config] = None) -> None:
        ...
        data = {
            ...
            "event": {
                ...
                "pay_money": config.event.pay_money,
                "viewers": config.event.viewers,
            },
            "strategy": {
